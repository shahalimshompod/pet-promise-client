    ...
    return (
        <nav className="bg-white shadow-lg py-2 px-3 xl:px-0 dark:bg-[#111827] sticky top-0 z-[1050]">
            <div className="container mx-auto flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <a href="/" className="text-4xl font-bold hidden lg:block">
                            ...
                            <span className="text-cyan-600 poppins font-extralight">PROMISE</span>
                        </a>
                    </div>
                </div>
                ...
                {/* Navigation Links */}
                <ul
                    className={`absolute bg-white dark:bg-[#111827] shadow-lg w-full md:w-auto left-0 top-16 md:top-0 md:hidden ${isMenuOpen ? "opacity-100 scale-100" : "opacity-0 scale-95 hidden"
                        }`}
                >
                    <li>
                        <NavLink
                            ...
                            className={({ isActive }) =>
                                `block px-4 py-2 md:p-0 text-sm poppins ${isActive ? "text-cyan-500 font-bold" : "text-black/60 dark:text-white/70"
                                }`
                            }
                        >
                            Home
                ...
                <div className="flex items-center gap-5">
                    ...
                    <div className="relative">
                        {
                            gettingUserLoading ? (<Skeleton circle={true} height={44} width={44} />)
                                :
                        ...
                        <div
                            className={`absolute right-0 mt-2 w-48 bg-white dark:bg-[#111827] border  rounded shadow-md transform transition-all duration-300 ease-in-out ${isProfileDropdownOpen
                    ...
                    <button onClick={handleDark} className="bg-white/50 p-3 rounded-full">
                        {isDark ? <LuSun className="dark:text-white" size={20} /> : <FaMoon size={20} />}
                    </button>
                </div>
            </div>
        </nav>
