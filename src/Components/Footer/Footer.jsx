                ...
                <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                    <div className="sm:flex justify-between flex flex-col lg:flex-row items-center gap-5 lg:gap-0 ">
                        ...
                        <ul className="flex flex-wrap items-center text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
                            <li>
                                <a href="/about" className="hover:underline me-4 md:me-6 poppins font-light">About</a>
                            </li>
                            <li>
                                <a href="#" className="hover:underline me-4 md:me-6 poppins font-light">Privacy Policy</a>
                            </li>
                            <li>
                                <a href="#" className="hover:underline me-4 md:me-6 poppins font-light">Licensing</a>
                            </li>
                            <li>
                                <a href="#" className="hover:underline poppins font-light">Contact</a>
                            </li>
                        </ul>
                    ...
                    <span className="block text-sm text-gray-500 text-center roboto dark:text-gray-400">© 2025 <span className="uppercase text-cyan-500">Petpromise.</span> All Rights Reserved.</span>
                </div>
            </footer>
