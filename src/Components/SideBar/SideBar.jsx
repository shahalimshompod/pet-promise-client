...
import { MdAddCircle, MdCampaign, MdCreateNewFolder, MdOutlinePets } from 'react-icons/md';
...
const SideBar = () => {
    ...
    return (
        <div className={`bg-cyan-100 dark:bg-[#111827] text-white w-full lg:max-w-72 p-5 flex flex-col items-center rounded-xl border-2 border-cyan-500 ${role === 'Admin' ? 'h-[800px]' : 'h-[600px]'} `}>
            ...
            <div className="flex flex-col items-center mb-4">
                ...
                />
                {
                    role === 'Admin' ? (<p className='dark:bg-cyan-50 bg-[#111827] dark:text-[#111827] text-cyan-50 px-4 my-2 rounded-lg nunito font-semibold border-2 border-cyan-500'>Admin</p>) : ''
                }
                <h2 className="mt-4 text-xl font-semibold poppins text-cyan-900 dark:text-cyan-50">{name}</h2>
                <p className="text-sm opacity-80 nunito text-cyan-900 dark:text-cyan-50">{email}</p>
            </div>
            ...
            <div className="w-full">
                ...
                <NavLink
                    ...
                    className={({ isActive }) =>
                        `flex items-center p-3 rounded-md mb-1 gap-3 ${isActive ? 'bg-cyan-600 text-white' : 'hover:bg-cyan-300 dark:hover:bg-cyan-50/50 text-cyan-950 dark:text-cyan-50'}`
                    }
                >
                    <CgProfile size={20} />
                ...
                >
                    ...
                    <span className="font-semibold text-lg nunito">Adoption requests</span>
                </NavLink>
