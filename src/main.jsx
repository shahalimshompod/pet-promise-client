...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: '/dashboard',
        element: <SecureRoute><DashboardLayout /></SecureRoute>,
        children: [
          {
            path: '/dashboard',
          ...
          },
          {
            ...
            element: <RedirectByRole><SecureRoute><Users /></SecureRoute></RedirectByRole>,
            loader: () => {
          ...
          },
          {
            ...
            element: <RedirectByRole><SecureRoute><AllPets /></SecureRoute></RedirectByRole>,
            loader: () => {
          ...
          },
          {
            ...
            element: <RedirectByRole><SecureRoute><AllCampaign /></SecureRoute></RedirectByRole>,
            loader: () => {
          ...
          },
          {
            ...
            element: <SecureRoute><AddAPet /></SecureRoute>,
            loader: () => {
          ...
          },
          {
            ...
            element: <SecureRoute><MyAddedPets /></SecureRoute>,
            loader: () => {
          ...
          },
          {
            ...
            element: <SecureRoute><AdoptionRequests /></SecureRoute>,
            loader: () => {
          ...
          },
          {
            ...
            element: <SecureRoute><CreateCampaign /></SecureRoute>,
            loader: () => {
          ...
          },
          {
            ...
            element: <SecureRoute><MyCampaigns /></SecureRoute>,
            loader: () => {
          ...
          },
          {
            ...
            element: <SecureRoute><MyDonation /></SecureRoute>,
            loader: () => {
